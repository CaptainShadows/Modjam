...
public class TECooler extends MainTE implements IInventory {
    ...
    public void readFromNBT(NBTTagCompound nbtTagCompound) {
        ...
        NBTTagList tagList = nbtTagCompound
                .getTagList("Items");
        inventory = new ItemStack[this.getSizeInventory()];
        for (int i = 0; i < tagList.tagCount(); ++i){
            NBTTagCompound tagCompound = (NBTTagCompound) tagList
                    .tagAt(i);
