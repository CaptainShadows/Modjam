...
public class GUICooler extends GuiContainer {
    ...
    public GUICooler(InventoryPlayer player,
            TECooler coolerTE) {
    ...
    @Override
    protected void drawGuiContainerForegroundLayer(int x,
            int y) {

        String containerName = CoolerTE
                .isInvNameLocalized() ? CoolerTE
                .getInvName() : StatCollector
                .translateToLocal(CoolerTE.getInvName());
        fontRenderer
                .drawString(
                        containerName,
                        xSize
                                / 2
                                - fontRenderer
                                        .getStringWidth(containerName)
                                / 2, 6, 4210752);
        fontRenderer.drawString(StatCollector
                .translateToLocal(Registry.ContainerINV),
    ...
    protected void drawGuiContainerBackgroundLayer(
        ...
        this.drawTexturedModalRect(xStart, yStart, 0, 0,
                xSize, ySize);
    }
}
